window.onload = function() {
    ...
    function createItems() {
        ...
        switch (day) {
            ...
            case 2:
                createFishInterval = setInterval(createFish, 800);
    ...
    function handleImageTouch(event) {
        ...
        // Open modal when an image is touched
        openModal();
    }
    
    // Add event listeners for touch events on images
    const images = document.querySelectorAll('.fish, .rare-fish'); // Assuming 'fish' and 'rare-fish' are the classes of your images
    images.forEach(image => {
        image.addEventListener('touchstart', handleImageTouch);
    });
